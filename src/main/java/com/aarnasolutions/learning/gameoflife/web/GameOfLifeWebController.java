...
public class GameOfLifeWebController {
    ...
    public String getGames(Model model) {
        List<Game> domainGames = this.gameService.getDomainGames();
    ...
    public String initGame(
        ...
        com.aarnasolutions.learning.gameoflife.data.entity.Game initiatedGame = gameService.initGame(playerName, numPlayers);
        List<Game> domainGames = this.gameService.getDomainGames();
        domainGames.forEach(
                game ->
                        game.setJoinPermissible(
    ...
    public String joinGame(
        ...
        List<Player> playersInGame = gameService.getPlayersByGameId(gameId);
